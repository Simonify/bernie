...
window.MediaStreamRecorder = function MediaStreamRecorder(mediaStream) {
    if (!mediaStream) {
...
window.MultiStreamRecorder = function MultiStreamRecorder(mediaStream) {
    if (!mediaStream) {
        throw 'MediaStream is mandatory.';
    }
...
window.WhammyRecorder = function WhammyRecorder(mediaStream) {
    // void start(optional long timeSlice)
    // timestamp to fire "ondataavailable"
    this.start = function(timeSlice) {
        timeSlice = timeSlice || 1000;
